...
gts = tf.convert_to_tensor(gts+0., dtype=tf.float32)
inputs = tf.convert_to_tensor(inputs+0., dtype=tf.float32)
outputs = tf.convert_to_tensor(outputs+0., dtype=tf.float32)
